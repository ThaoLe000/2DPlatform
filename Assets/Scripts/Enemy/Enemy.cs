...
public class Enemy : MonoBehaviour
{
    ...
    protected virtual void HandleCollision()
    {
        ...
        isWallDetected = Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y - 0.2f), Vector2.right * facingDir, wallCheckDistance, whatIsGround);
    ...
    protected virtual void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(
            ...
            new Vector2(transform.position.x + (wallCheckDistance * facingDir), transform.position.y - 0.2f)
        );
